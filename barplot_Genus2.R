...
p<-list()
##############
for (k in unique(meta$Type)) {
  
  meta1<-subset(meta,Type== k)
...
library(gridExtra)
tiff(filename = "barplot_Genus_4.tiff",
